        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
                <Card className="relative overflow-hidden p-6 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Badge className="bg-emerald-50 text-emerald-700 font-bold border-0">Income</Badge>
                    </div>
                    <div className="mt-5">
            ...
            <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.05 }}>
                <Card className="relative overflow-hidden p-6 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Badge className="bg-rose-50 text-rose-700 font-bold border-0">Expenses</Badge>
                    </div>
                    <div className="mt-5">
            ...
            <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.1 }}>
                <Card className="relative overflow-hidden p-6 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Badge className={netCashflow >= 0 ? "bg-emerald-50 text-emerald-700 font-bold border-0" : "bg-rose-50 text-rose-700 font-bold border-0"}>
                            {netCashflow >= 0 ? "Surplus" : "Deficit"}
                        </Badge>
                    </div>
                    <div className="mt-5">
                        <p className="text-xs font-bold uppercase tracking-wider text-slate-400">Net Cashflow</p>
                        <h3 className={`mt-1 text-xl font-bold sm:text-2xl ${netCashflow >= 0 ? "text-slate-900" : "text-rose-600"}`}>
            ...
            <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.15 }}>
                <Card className="relative overflow-hidden p-6 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="rounded-2xl bg-violet-50 p-3.5 text-violet-600">
