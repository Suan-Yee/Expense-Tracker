                ...
                <div>
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-semibold text-slate-400">
                            {categoryData.length > 4 ? "Top 4 Categories" : "By Category"}
                        </span>
                    </div>
                    <p className="text-xs text-slate-400 mt-0.5">Distribution of expenses across categories</p>
                </div>
                ...
                <div className="my-6 flex h-[260px] items-center justify-center">
                    {pieData.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center text-center">
                            <PieIcon size={40} className="text-slate-200 mb-2" />
                    ...
                    {categoryData.slice(0, 4).map((cat) => (
                        <div key={cat.category} className="flex items-center justify-between pt-2 first:pt-0 text-xs">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-bold text-slate-700 capitalize">{cat.category}</span>
                            </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <h3 className="font-bold text-slate-800">Cashflow Comparison</h3>
                        </div>
